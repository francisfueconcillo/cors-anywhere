...
function getHandler(options, proxy) {
  var corsAnywhere = {
    handleInitialRequest: null,     // Function that may handles the request or modifies request or location. Returns and object { req, location, handled }. If handled=true, no further steps needed.
  ...
  return function(req, res) {
    ...
    if (corsAnywhere.handleInitialRequest) {
      ({ req, res, location, handled } = corsAnywhere.handleInitialRequest(req, res, location));
      if (handled) {
        return;
      }
    }
